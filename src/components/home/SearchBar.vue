    ...
    <div>
        <div class="search-bar" :class="{'hide-title': !titleVisible, 'hide-shadow': !shadowVisible}">
            ...
            <div class="search-bar-title-wrapper" v-show="titleVisible">
                ...
                <div class="title-icon-shake-wrapper" @click="showFlapCard"><span class="icon-shake icon"></span></div>
            </div>
            </transition>
            <transition>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .search-bar {
      ...
      &.hide-title {
          height: px2rem(52);// search-bar隐藏时高度
      }
      &.hide-shadow {
          box-shadow: none;
      }
      ...
      .title-icon-back-wrapper {
          ...
          @include center;
          &.hide-title {
              height: px2rem(52);// 变成和search-bar隐藏时一样高
          }
      }
